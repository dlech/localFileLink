========================================================================
    ACTIVE TEMPLATE LIBRARY : LocalFileLink Project Overview
========================================================================

AppWizard has created this LocalFileLink project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

LocalFileLink.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

LocalFileLink.vcxproj.filters
...
LocalFileLink.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (LocalFileLink.h)
        GUID definitions                                (LocalFileLink_i.c)
        A type library                                  (LocalFileLink.tlb)
        Marshaling code                                 (LocalFileLink_p.c and dlldata.c)

LocalFileLink.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in LocalFileLink.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named LocalFileLink.pch and a precompiled types file named StdAfx.obj.
...
LocalFileLinkps.vcxproj
	...
	dlldata.c, LocalFileLink_i.c and LocalFileLink_p.c which are required
	to build the proxy/stub DLL.

LocalFileLinkps.vcxproj.filters
